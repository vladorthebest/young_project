...
def numbers_in_list(main_list):
    ...
    for index, item in enumerate(all_list): # take one list with numbers
        for next_item in all_list[index+1 :]: # compare it to everyone else
...
main_list = [[2,10],[3,10],[5,20],[20,50],[9,100],[5,15]]
